...
import { creatSubcategory, getSubcategory } from '../../../Redux/ActionCreators/SubcategoryActioncreators'
     ...
     async function postdata(e) {
          ...
          if (error)
               ...
               if (items) {
                    ...
                    dispetch(creatSubcategory({ ...data }))
               ...
               <div className="container-fluid my-3">
                    <div className="row">
                         ...
                         <div className="col-xl-10 col-md-9">
                              <div className="row">
                                   <h5 className='bg-primary border-primary p-2 text-white text-center'>Create<Link to='/admin/subcategory'><i className='fa fa-arrow-left float-end text-white'></i></Link ></h5>
                              </div>
                              <form onSubmit={postdata}>
                                   <div className="row ">
                                        <div className="col-md-6 mb-2">
                                             <label htmlFor="username">name*</label>
                                             <input type="text" name="name" onChange={getInputData} placeholder='Subcategory Name' className={`form-control text-capitalize ${show && errorMessage.name ? "border-danger" : "border-primary"} border-2`} />
