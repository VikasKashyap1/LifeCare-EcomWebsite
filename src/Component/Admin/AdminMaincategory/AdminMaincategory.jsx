...
export default function AdminMaincategory() {
     ...
     function DeleteData(id) {
          if (window.confirm("Are you sure you want to delete details?")) {
               dispetch(deleteMaincategory({ id: id }))
               GetAPIData()
               ...
               <div className="container-fluid my-3">
                    <div className="row">
                         ...
                         <div className="col-xl-10 col-md-9">
                              <div className="row">
                                   <h5 className='bg-primary border-primary p-2 text-white text-center'>Maincategory<Link to='/admin/maincategory/create'><i className='fa fa-plus float-end text-white'></i></Link ></h5>
